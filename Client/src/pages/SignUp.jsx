          ...
          <div>
            ...
            />
                <label htmlFor="terms" className="ml-2 block text-sm text-gray-700">
                  I agree to the{' '}
                  <a href="#" className="text-indigo-600 hover:text-indigo-500 transition">
        ...
        <div className="relative flex flex-col justify-center h-full px-12">
          <div className="max-w-lg mx-auto text-center text-white">
            ...
            <p className="text-xl text-indigo-100 mb-8 leading-relaxed">
              Thousands of professionals trust us to manage their customer relationships and grow their business efficiently.
            </p>
            ...
            <div className="space-y-4 text-left max-w-md mx-auto">
              <div className="flex items-center">
                ...
                <span className="text-indigo-100">Manage unlimited contacts</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-indigo-100">Advanced analytics & reports</span>
              </div>
              ...
              <div className="flex items-center">
                ...
                <span className="text-indigo-100">Secure data protection</span>
              </div>
            </div>
            
            <div className="mt-12 pt-8 border-t border-white/20">
              <p className="text-indigo-200 text-sm">
                "This platform transformed how we manage our customer relationships. Highly recommended!"
              </p>
              <p className="text-white font-semibold mt-2">— Sarah Johnson, CEO</p>
            </div>
          </div>
        </div>
      </div>
